...
export const Thumbnail = ({ isLive, src, fallback, username }: ThumbnailProps) => {
	let content;
	...
	return (
		<div className="group aspect-video relative rounded-md cursor-pointer">
			<div className="absolute rounded-md inset-0 bg-blue-500 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center" />
